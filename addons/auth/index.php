...
Route::get('/auth/new-user', function () {
    ...
    if (!empty($authToken) && !empty($token)) {
        ...
        if ($token != $authToken) {
            $_SESSION['msg'] = lang('auth.token_invalid');
            $_SESSION['msg_type'] = 'error';
        } else {
            $_SESSION['msg'] = lang('auth.token_valid');
...
Route::get('/auth/forgot-password', function () {
    ...
    $breadcrumb = [
        ['name' => lang('auth.password_forgot')]
    ];
    include BASEPATH . "/header.php";
...
Route::post('/auth/forgot-password', function () {
    ...
    if (isset($_POST['mail'])) {
        ...
        sendMail(
            ...
            lang('auth.password_reset_click_link') .
...
?>
    <form action="#" method="post">
        ...
        <div class="form-group">
            <label class="required" for="password"><?= lang('auth.password_new') ?></label>
