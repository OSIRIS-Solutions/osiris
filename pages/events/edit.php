...
<div class="container w-600 mw-full">
    ...
    <blockquote>
        ...
        <?=lang('Here you can create events such as conferences, workshops or other events. These are created centrally and can be viewed by other users. It is then easy to add contributions such as presentations or posters to these events. <b>An event is not an activity!</b> It is not assigned to a person and is not a service in itself. The event is only used for the central administration of events and for linking to contributions.', 
