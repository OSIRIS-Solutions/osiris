            ...
            <tbody>
                <?php foreach ($links as $link): ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger btn-sm" onclick="$(this).closest('tr').remove()"><i class="ph ph-trash" title="<?= lang('system.delete') ?>"></i></button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
            ...
            function addLink() {
                ...
                const newRow = `
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-danger btn-sm" onclick="$(this).closest('tr').remove()"><i class="ph ph-trash" title="<?= lang('system.delete') ?>"></i></button></td>
                            </tr>`;
                tbody.append(newRow);
            }
        </script>
