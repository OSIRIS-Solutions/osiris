...
<nav class="pills mt-20 mb-0">
    ...
    <!-- colors -->
    <a onclick="navigate('design')" id="btn-design" class="btn">
...
<section id="design" style="display: none;">
    ...
    <form action="<?= ROOTPATH ?>/crud/admin/general" method="post" id="design-form">
        ...
        <div class="box primary">
            ...
            <div class="content">
                <h2 class="title"><?= lang('Design Settings', 'Designeinstellungen') ?></h2>

            </div>
            <table class="table simple" id="design-table">
                <tr>
