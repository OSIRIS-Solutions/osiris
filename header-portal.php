            ...
            <div class="container">
                ...
                <div class="dropdown modal-sm">
                    <button class="btn primary mr-5" data-toggle="dropdown" type="button" id="accessibility-menu" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="sr-only"><?= lang('common.accessibility_options') ?></span>
                    </button>
                        ...
                        <form action="<?= ROOTPATH ?>/set-preferences" method="get" class="content pt-0">
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox">
                                    ...
                                    <label for="set-contrast"><?= lang('common.high_contrast') ?></label><br>
                                    <small class="text-muted">
                                        <?= lang('common.high_contrast_description') ?>
                                    </small>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                    ...
                                    <label for="set-transitions"><?= lang('common.reduce_motion') ?></label><br>
                                    <small class="text-muted">
                                        <?= lang('common.reduce_motion_description') ?>
                                    </small>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-checkbox">
                                    ...
                                    <label for="set-dyslexia"><?= lang('common.dyslexia_mode') ?></label><br>
                                    <small class="text-muted">
                                        <?= lang('common.dyslexia_mode_description') ?>
                                    </small>
                                </div>
                            </div>
